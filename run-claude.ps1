...
# Triggered by Windows Task Scheduler or macOS launchd ("apartment-manager Claude Overnight", 9PM / 2AM).
...
$projectPath = "/Users/alyssamarieborbon/Downloads/Vibe coding/apartment-manager"

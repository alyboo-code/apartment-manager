...
$taskName   = "apartment-manager Command Dispatcher"
...
# =============================================================================================
if (-not $OnWindows) {
    $dispatchScript = "/Users/alyssamarieborbon/Downloads/Vibe coding/apartment-manager/tools/Dispatch-Commands.ps1"
    $label    = "com.aidevos.apartment-manager.dispatcher"
...
# =============================================================================================
$scriptPath = "/Users/alyssamarieborbon/Downloads/Vibe coding/apartment-manager\tools\Dispatch-Commands.ps1"
